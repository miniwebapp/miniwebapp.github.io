import{r as D,p as O,R as j}from"./index-a576c8ed.js";const m=t=>{let e;const n=new Set,o=(s,p)=>{const i=typeof s=="function"?s(e):s;if(!Object.is(i,e)){const f=e;e=p??typeof i!="object"?i:Object.assign({},e,i),n.forEach(E=>E(e,f))}},r=()=>e,l={setState:o,getState:r,subscribe:s=>(n.add(s),()=>n.delete(s)),destroy:()=>{n.clear()}};return e=t(o,r,l),l},A=t=>t?m(t):m;var b={exports:{}},g={},w={exports:{}},R={};/**
 * @license React
